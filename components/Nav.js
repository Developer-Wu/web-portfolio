...
function Nav(props) {
    ...
    return (
        ...
        <HStack display={{base:"none", sm:"flex", md:"flex", lg:"flex"}} mr={{base:"70px",md:"70px",lg:"0px"}} top="40px" pos="relative" align="center" justify="flex-end" spacing="20px" width="100%" maxWidth="1250px">
